...
- If GitHub-hosted sync should open pull requests, enable "Allow GitHub Actions to create and approve pull requests" in repository Actions settings or provide a dedicated token secret.
